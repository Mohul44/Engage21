...
class EditTaskPage extends StatefulWidget {
  ...
  final int vaccine;
  const EditTaskPage(this.userid, this._Course, this._Lecturer,
      this._StartingTIme, this._Venue, this._onLine, this.repeat, this.vaccine);
  @override
  _CreateNewTaskPageState createState() => _CreateNewTaskPageState();
}

class _CreateNewTaskPageState extends State<EditTaskPage> {
  ...
  List<dynamic> mylist = [false, true, false, true, false, true, false];
